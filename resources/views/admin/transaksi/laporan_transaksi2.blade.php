    ...
    <div class="col-md-12">
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <br/>
              <br/>
              <span>Laporan transaksi {{ $from }} sampai {{ $to }}</span>
              ...
              <span>Total uang produk : {{ "Rp ".number_format($uang,2, ',', '.') }} (sudah termasuk potongan reseller)</span><br/>
              <span>Total ongkos kirim : {{ "Rp ".number_format($ongkir->ongkir,2, ',', '.') }}</span><br/>
              <span>Total uang masuk : {{ "Rp ".number_format($total->total,2, ',', '.') }}</span>
              </div>
