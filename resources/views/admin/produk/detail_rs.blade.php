                    ...
                    <div class="row">
                       ...
                       <table id="example1" class="table dataTable table-striped"style="width: 80%;margin-left: 15%;" >
                            ...
                            <tr>
                              ...
                              <td><a class="btn btn-default2" border="1 solid #999" data-idp="{{$data->id}}" data-s="{{$row->stock}}" data-hp="{{$row->harga_pokok}}" data-ht="{{$row->harga_tambah}}" data-id="{{$row->id_produk_ukuran}}" id="buttoncheckout" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="#"><i class="fa fa-edit"></i>   Edit Produk</a></td>
                            </tr>
                            @endforeach
                        </table>
